...
public class GlobalCrawlerControl {
    ...
    public GlobalCrawlerControl(String x, int y, int z, int a, int b, String c) throws Exception{
        
        crawlStorageFolder = x + "/"+"Global";
        numberOfCrawlers = y;
        politenessDelay = z;
        ...
        controller.start(GlobalCrawler.class, numberOfCrawlers);
    }
}